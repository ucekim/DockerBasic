...
app.config['MYSQL_DATABASE_PASSWORD'] = 'josepf_1'
...
# Write a function named `home` which returns 'Welcome to the Josepf's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Josepf's Bookstore API Service"
